...
static const uint64_t hash1 = 0x0a9d71ad1830e32a;
static const uint64_t hash2 = 0x2444b7dcfa59e325;
static const uint64_t hash3 = 0x77cafa63afbbf22d;
static const uint64_t hash4 = 0x14934debfc43de63;
